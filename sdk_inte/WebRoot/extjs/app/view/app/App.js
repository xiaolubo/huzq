Ext.define('sdkinte.view.app.App', {  
    extend : 'Ext.panel.Panel',  
  
    alias : 'widget.apppricepanel',  
  
    requires : ['sdkinte.view.app.AppController','sdkinte.view.app.AppModel'],  
  
   uses : [ 'sdkinte.view.app.AppGrid'],
