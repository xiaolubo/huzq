...
Ext.define('sdkinte.view.singleSdk.SinglesdkModel', {  
            extend : 'Ext.app.ViewModel',  
            alias : 'viewmodel.singlesdk',  
            ...
            data : {  
                ...
                tf_ModuleGroup : 'sdk信息',// 模块分组：模块分到哪个组里，比如说业务模块1、业务模块2、系统设置、系统管理等。  
                tf_moduleName : 'Global', // 模块标识：系统中唯一的模块的标识  
                tf_title : 'sdk列表',// 模块名称：能够描述此模块信息的名称。  
