Ext.define('sdkinte.view.singleSdk.Singlesdk', {  
    extend : 'Ext.panel.Panel',  
  
    alias : 'widget.singlesdkpanel',  
  
    requires : ['sdkinte.view.singleSdk.SinglesdkController','sdkinte.view.singleSdk.SinglesdkModel'],  
  
   uses : [ 'sdkinte.view.singleSdk.SinglesdkGrid'],
    ...
    initComponent : function() {  
        ...
        this.items = [{  
                    xtype : 'singlesdkgrid', // 模块的grid显示区域  
                    region : 'center'  
