Ext.define('sdkinte.view.requestlog.Requestlog', {  
    extend : 'Ext.panel.Panel',  
  
    alias : 'widget.requestlogpanel',  
  
    requires : ['sdkinte.view.requestlog.RequestlogController','sdkinte.view.requestlog.RequestlogModel'],  
  
   uses : [ 'sdkinte.view.requestlog.RequestlogGrid'],
    ...
    initComponent : function() {  
        ...
        this.items = [{  
                    xtype : 'requestloggrid', // 模块的grid显示区域  
                    region : 'center'  
