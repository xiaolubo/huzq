Ext.define('sdkinte.view.singleApp.Singleapp', {  
    extend : 'Ext.panel.Panel',  
  
    alias : 'widget.apppanel',  
  
    requires : ['sdkinte.view.singleApp.SingleappController','sdkinte.view.singleApp.SingleappModel'],  
  
   uses : [ 'sdkinte.view.singleApp.SingleappGrid'],
    ...
    initComponent : function() {  
        ...
        this.items = [{  
                    xtype : 'singleApprid', // 模块的grid显示区域  
                    region : 'center'  
