Ext.define('sdkinte.view.channel.Channel', {  
    extend : 'Ext.panel.Panel',  
  
    alias : 'widget.channelPanel',  
  
    requires : ['sdkinte.view.channel.ChannelController','sdkinte.view.channel.ChannelModel'],  
  
   uses : [ 'sdkinte.view.channel.ChannelGrid'],
