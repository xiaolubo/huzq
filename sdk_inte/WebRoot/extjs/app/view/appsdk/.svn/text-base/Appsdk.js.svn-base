Ext.define('sdkinte.view.appsdk.Appsdk', {  
    extend : 'Ext.panel.Panel',  
  
    alias : 'widget.appsdkpanel',  
  
    requires : ['sdkinte.view.appsdk.AppsdkController','sdkinte.view.appsdk.AppsdkModel'],  
  
   uses : [ 'sdkinte.view.appsdk.AppsdkGrid'],
